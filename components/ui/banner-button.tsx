...
export function AnimatedGradientTextDemo() {
  return (
    <div className="group relative flex items-center justify-center rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f] ">
      <span
        className={cn(
          "absolute inset-0 block h-full w-auto animate-gradient rounded-[inherit] bg-gradient-to-r from-[#ffaa40]/50 via-[#9c40ff]/50 to-[#ffaa40]/50 bg-[length:300%_100%] p-[1px]"
        )}
        style={{
          WebkitMask:
      ...
      />
      ✨ <hr className="mx-2 h-4 w-px shrink-0 bg-neutral-500 dark:bg" />
      <AnimatedGradientText className="text-sm font-medium">
        Introducing AdMyBrand AI Suite
