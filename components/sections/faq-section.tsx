...
export function FAQSection() {
  ...
  return (
    <section
      id="faq"
      className="py-24 px-4 sm:px-6 lg:px-8 min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:bg-gradient-to-br dark:from-black dark:via-black dark:to-black"
    >
